...
public class UserValidationTest
{
    ...
    @Test
    public void whenGivenEmailHasMin8CharOrMOre_MustHave1UpperCase_1Numaric_AndOnly1SpecialChar_ThenReturnTrue()
    {
        Assert.assertTrue(uservalidation.validatePassword("Nitin@12345"));
    }
    @Test
    public void whenGivenEmailHas_LessThen8Char_ThenReturnFalse()
    {
        Assert.assertFalse(uservalidation.validatePassword("Ni@123"));
    }
    @Test
    public void whenGivenEmailHas_NoUpperCase_ThenReturnFalse()
    {
        Assert.assertFalse(uservalidation.validatePassword("nitin@123"));
    }
    @Test
    public void whenGivenEmailHas_NoNumaricValue_ThenReturnFalse()
    {
        Assert.assertFalse(uservalidation.validatePassword("nitin@Makin"));
    }
    @Test
    public void whenGivenEmailHas_NoSpecialChar_ThenReturnFalse()
    {
        Assert.assertFalse(uservalidation.validatePassword("nitin123"));
    }
}
